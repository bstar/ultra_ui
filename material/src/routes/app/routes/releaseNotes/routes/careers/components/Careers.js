  ...
  <article className="article">
    ...
    <div className="row">
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">devices</i></a>
          </div>
      ...
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">access_time</i></a>
          </div>
      ...
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">directions_bike</i></a>
          </div>
          <h3>A new bike</h3>
    ...
    <div className="row">
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">attach_money</i></a>
          </div>
      ...
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">local_hospital</i></a>
          </div>
      ...
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">people_outline</i></a>
          </div>
    ...
    <div className="row">
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">card_giftcard</i></a>
          </div>
          <h3>Monthly gift</h3>
      ...
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">autorenew</i></a>
          </div>
      ...
      <div className="col-xl-4">
        <div className="icon-box ibox-plain">
          <div className="ibox-icon">
            <a href={DEMO.link}><i className="material-icons">favorite_border</i></a>
          </div>
